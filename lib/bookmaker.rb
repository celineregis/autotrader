module Bookmaker
	...
	def get_live_hash_inwt(line, home, away, points, over, under)
		string_for_test = "wrapper(eventStartInMinutesAgo=0, redCards=0, matchStatus=1, playingMinute=10, hcpParameter=#{line}, hcpHome=#{home}, hcpAway=#{away}, ouParameter=#{points}, ouOver=#{over}, ouUnder=#{under}, homeGoals=0, awayGoals=0)"
